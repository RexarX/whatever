...
def main() -> int:
    ...
    print_info("Embedded - Code Formatting Tool")
    print_info("=" * 45)
    ...
    # Define source directories (embedded-specific)
    source_dirs = [
        project_root / "main",
        project_root / "src",
    ...
    exclude_dirs = [
        project_root / "build",
        project_root / "components" / "nanopb",  # Don't format third-party code
    ]
