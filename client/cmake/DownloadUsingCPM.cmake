# CPM (CMake Package Manager) integration for Phone Holder Client
...
macro(client_cpm_add_package)
    ...
    if(NOT CPM_ARG_NAME)
        message(FATAL_ERROR "client_cpm_add_package: NAME is required")
    endif()
...
function(client_print_cpm_packages)
    if(CPM_PACKAGES)
...
function(client_cpm_add_github_package)
    set(options)
    ...
    if(NOT ARG_NAME OR NOT ARG_REPOSITORY)
        message(FATAL_ERROR "client_cpm_add_github_package: NAME and REPOSITORY are required")
    endif()
    ...
    client_cpm_add_package(${_args})
endfunction()

# Mark targets from CPM as system includes
function(client_cpm_mark_as_system target)
    if(TARGET ${target})
